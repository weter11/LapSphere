...
impl ControlInterface {
    ...
    async fn get_fan_speeds(&self) -> Result<String, zbus::fdo::Error> {
        match crate::hardware_detection::get_fan_speeds() {
            Ok(fans) => {
                serde_json::to_string(&fans).map_err(|e| zbus::fdo::Error::Failed(e.to_string()))
            }
            Err(e) => Err(zbus::fdo::Error::Failed(e.to_string())),
        }
    }
    ...
    async fn get_fan_temperature(&self, fan_id: u32) -> Result<u32, zbus::fdo::Error> {
        if !crate::tuxedo_io::TuxedoIo::is_available() {
            return Err(zbus::fdo::Error::Failed(
                "tuxedo_io not available".to_string(),
            ));
        }
    ...
    async fn get_battery_charge_start_threshold(&self) -> Result<u8, zbus::fdo::Error> {
        match crate::battery_control::BatteryControl::new() {
            Ok(battery) => battery
                .get_charge_control_start_threshold()
                .map_err(|e| zbus::fdo::Error::Failed(e.to_string())),
            Err(e) => Err(zbus::fdo::Error::Failed(e.to_string())),
        }
    }

    async fn set_battery_charge_start_threshold(
        &self,
        threshold: u8,
    ) -> Result<(), zbus::fdo::Error> {
        match crate::battery_control::BatteryControl::new() {
            Ok(battery) => battery
                .set_charge_control_start_threshold(threshold)
                .map_err(|e| zbus::fdo::Error::Failed(e.to_string())),
            Err(e) => Err(zbus::fdo::Error::Failed(e.to_string())),
        }
    }
    ...
    async fn set_battery_charge_end_threshold(
        &self,
        threshold: u8,
    ) -> Result<(), zbus::fdo::Error> {
        match crate::battery_control::BatteryControl::new() {
            Ok(battery) => battery
                .set_charge_control_end_threshold(threshold)
                .map_err(|e| zbus::fdo::Error::Failed(e.to_string())),
            Err(e) => Err(zbus::fdo::Error::Failed(e.to_string())),
        }
    }
    ...
    async fn get_battery_available_start_thresholds(&self) -> Result<String, zbus::fdo::Error> {
        match crate::battery_control::BatteryControl::new() {
            Ok(battery) => {
                let thresholds = battery
                    .get_available_start_thresholds()
                    .map_err(|e| zbus::fdo::Error::Failed(e.to_string()))?;
    ...
    async fn set_memory_locked_clocks(
        &self,
        device_index: u32,
        min_clock: u32,
        max_clock: u32,
    ...
    async fn get_gpu_clock_ranges(&self, device_index: u32) -> Result<String, zbus::fdo::Error> {
        match crate::hardware_detection::get_gpu_clock_ranges(device_index) {
            Ok(ranges) => {
                serde_json::to_string(&ranges).map_err(|e| zbus::fdo::Error::Failed(e.to_string()))
            }
            Err(e) => Err(zbus::fdo::Error::Failed(e.to_string())),
        }
    }

    async fn get_gpu_mem_clock_ranges(
        &self,
        device_index: u32,
    ...
    async fn set_gpu_memory_offset(
        &self,
        device_index: u32,
        offset: i32,
    ) -> Result<(), zbus::fdo::Error> {
    ...
    async fn get_gpu_core_offset_limits(
        &self,
        device_index: u32,
    ) -> Result<(i32, i32), zbus::fdo::Error> {
        crate::hardware_detection::get_gpu_core_offset_limits(device_index)
            .map_err(|e| zbus::fdo::Error::Failed(e.to_string()))
    }

    async fn get_gpu_memory_offset_limits(
        &self,
        device_index: u32,
    ) -> Result<(i32, i32), zbus::fdo::Error> {
    ...
    async fn update_polling_interval(
        &self,
        component: &str,
        interval_ms: u64,
    ) -> Result<(), zbus::fdo::Error> {
        if let Some(handle) = crate::SCHEDULER_HANDLE.get() {
            ...
            handle
                .update_interval(component.to_string(), interval)
                .map_err(|e| zbus::fdo::Error::Failed(e.to_string()))
        } else {
...
fn is_systemd_managed() -> bool {
    std::env::var_os("INVOCATION_ID").is_some() || std::env::var_os("SYSTEMD_EXEC_PID").is_some()
}
